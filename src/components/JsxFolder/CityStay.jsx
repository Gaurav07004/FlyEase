...
import Bund from "D:/Development/Web-development/ReactJs/flyease/client/src/assets/Bund.png";
import Sydney from "D:/Development/Web-development/ReactJs/flyease/client/src/assets/Sydney.png";
import Kyoto from "D:/Development/Web-development/ReactJs/flyease/client/src/assets/kyoto.png";
import bp_1 from "D:/Development/Web-development/ReactJs/flyease/client/src/assets/bp_1.webp";
import maldives from "D:/Development/Web-development/ReactJs/flyease/client/src/assets/maldives.png";
import Tokyo from "D:/Development/Web-development/ReactJs/flyease/client/src/assets/Tokyo.webp";
import Moroco from "D:/Development/Web-development/ReactJs/flyease/client/src/assets/Moroco.png";
import Paris from "D:/Development/Web-development/ReactJs/flyease/client/src/assets/Paris.webp"
import about_1 from "D:/Development/Web-development/ReactJs/flyease/client/src/assets/about_1.webp";
import about_2 from "D:/Development/Web-development/ReactJs/flyease/client/src/assets/about_2.webp";
            ...
            <main className="city_stay">
                <main className=" About_us" id="AboutUs" >
                    <section className="About_us_detail">
                        ...
                        <div className="text-zinc-600 font-semibold tracking-wider Sub_heading text-4xl "><div>Discover Your Travel With</div><div>FlyEase</div></div>
                        <div className="text-zinc-600 text-justify pt-3 para_1">Welcome to FlyEase, your gateway to a world of hassle-free and unforgettable travel experiences. At FlyEase, we believe that travel should be easy, enjoyable, and accessible to everyone. Whether you are an avid explorer or a first-time traveler, we are here to make your journey seamless and stress-free.</div>
                        <div className="text-zinc-600 text-justify pt-3 para_2">Whether you are embarking on a solo adventure, planning a family vacation, or organizing a business trip, FlyEase is here for you. Join us on the journey where travel is not just a destination but an experience in itself.</div>
                    </section>
